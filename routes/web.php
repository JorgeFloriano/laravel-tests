...
Route::get(uri: '/user/create', action: [UserController::class, 'create'])
    ->name(name: 'user.create')
    ->middleware(middleware: 'guest');
Route::post(uri: '/user/store', action: [UserController::class, 'store'])->name(name: 'user.store');
